    ...
    <div class="container">
        ...
        <form action="{{ route('owner.profil.update') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" class="form-control" value="{{ $owner->akun->email }}" required>
            </div>
            <div class="form-group">
                <label for="username">Username</label>
                <input type="text" name="username" class="form-control" value="{{ $owner->akun->username }}" required>
            </div>
            <div class="form-group">
