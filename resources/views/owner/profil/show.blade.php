        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="bg-gradient-to-r from-[#877B66] to-[#A08B75] p-8 text-white relative">
                ...
                <div class="relative z-10">
                    <h2 class="text-2xl font-bold text-center">{{ $owner->nama ?? 'Nama Owner' }}</h2>
                    <p class="text-center text-white text-opacity-90 mt-2">Owner</p>
                </div>
            </div>
            ...
            <div class="p-8">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-[#877B66] font-medium">{{ $owner->nama ?? 'Belum diisi' }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-[#877B66] font-medium">{{ $owner->no_hp ?? 'Belum diisi' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="space-y-4">
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-[#877B66] font-medium">{{ $owner->akun->email ?? 'Belum diisi' }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-[#877B66] font-medium">{{ $owner->akun->username ?? 'Belum diisi' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 mt-8 pt-6 border-t border-gray-100">
                    <a href="{{ route('owner.profil.edit') }}"
