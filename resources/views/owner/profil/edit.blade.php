        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="bg-gradient-to-r from-[#877B66] to-[#A08B75] p-6 text-white relative">
                ...
                <div class="relative z-10 flex items-center">
                    <div>
                        <h2 class="text-2xl font-bold">Update Profil Owner</h2>
            ...
            <div class="p-8">
                ...
                <form action="{{ route('owner.profil.update') }}" method="POST" class="space-y-6" id="profileForm">
                    @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="email"
                                           ...
                                           value="{{ old('email', $owner->akun->email) }}"
                                           required
                            ...
                            <div class="form-group">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old('username', $owner->akun->username) }}"
                                           required
